...
export function WorkoutsPage({ userData, onWorkoutsChange }: WorkoutsPageProps) {
    ...
    const sortedWorkouts = [...userData.workouts].sort((a, b) =>
            ...
            {sortedWorkouts.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-muted-foreground mt-1">
                        Start by adding your first workout session
                    </p>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            selected workout and all its data.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
