...
export default function RecommendationsView({ recommendations, onPlaySong }: RecommendationsViewProps) {
  return (
    <div className="p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {recommendations.map((song) => (
            <div key={song.id} className="group relative cursor-pointer">
              ...
              <h3 className="mt-2 font-medium line-clamp-1 group-hover:text-primary transition-colors duration-300">
                {song.title}
              </h3>
